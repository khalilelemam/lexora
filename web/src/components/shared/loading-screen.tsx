...
export function LoadingScreen({
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center gap-8 rounded-2xl bg-[#f3edd7] p-12 shadow-2xl border border-[#51513d]/18 text-center max-w-md w-full">
        <LexoraLogo size="lg" animate showText={false} />
        <div className="flex flex-col items-center gap-3">
          <p className="text-xl font-black text-[#1b2021] tracking-tight">{message}</p>
          ...
          <p className="mt-2 text-xs font-medium text-[#51513d]/60 uppercase tracking-widest">
            Please wait
          </p>
        </div>
      </div>
