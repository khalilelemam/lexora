...
export default function HomePage() {
  return (
    <main className="bg-background min-h-screen">
      ...
      <section className="px-6 py-12">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="text-muted-foreground mt-3 text-center text-xs">
            <span className="mr-1 inline-block h-2 w-2 rounded-full bg-[oklch(0.70_0.10_115/0.6)] align-middle" />
            Forward fixation
            <span className="mx-3">•</span>
            <span className="mr-1 inline-block h-2 w-2 rounded-full bg-[oklch(0.52_0.12_25/0.6)] align-middle" />
            Regression
          </p>
        </div>
      </section>
      ...
      {/* ── Stats ────────────────────────────────────────── */}
      <section className="bg-card/50 border-y py-12">
        ...
        <div className="mx-auto max-w-3xl">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-4 leading-relaxed">
              Lexora is developed as part of a research project at the Faculty of Computing and Data
              Science. The platform combines eye-tracking technology with machine learning to
              provide accessible, non-invasive dyslexia screening.
            </p>
            <p className="text-muted-foreground mb-8 leading-relaxed">
              This tool is intended for research and screening purposes only — it does not provide a
              clinical diagnosis. Results should be interpreted by qualified professionals.
            </p>
